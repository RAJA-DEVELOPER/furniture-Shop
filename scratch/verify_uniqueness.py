...
# List of 110+ COMPLETELY DISTINCT Unsplash photo IDs with specific width/formatting parameters
# Every single entry in this array is unique!

MAPPING = {
    # -------------------------------------------------------------
    # INDEX.HTML (15 unique images)
    # -------------------------------------------------------------
    "index.html": [
        "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=1600&auto=format&fit=crop&q=85", # Hero BG (living room)
    ...
    # -------------------------------------------------------------
    # ABOUT.HTML (8 unique images)
    # -------------------------------------------------------------
    "about.html": [
        "https://images.unsplash.com/photo-1618219908412-a29a1bb7b86e?w=1600&auto=format&fit=crop&q=85", # Hero BG
        "https://images.unsplash.com/photo-1600573472591-ee6b68d14c68?w=900&auto=format&fit=crop&q=85",  # Story image
        "https://plus.unsplash.com/premium_photo-1661331747255-25854e79d9b6?w=600&auto=format&fit=crop&q=60", # Elena Beaumont portrait
        "https://images.unsplash.com/photo-1553484771-898ed465e931?w=600&auto=format&fit=crop&q=60",  # Marco Ricci portrait
        "https://images.unsplash.com/photo-1681949222860-9cb3b0329878?w=600&auto=format&fit=crop&q=60",  # Yuki Tanaka portrait
        "https://images.unsplash.com/photo-1716703741458-417a8d58f20e?w=600&auto=format&fit=crop&q=60",  # Amara Osei portrait
        "https://images.unsplash.com/photo-1611485988300-b327272a18b3?w=700&auto=format&fit=crop&q=80",  # Master woodworker carving
        "https://images.unsplash.com/photo-1538688525198-9b88f6f53126?w=700&auto=format&fit=crop&q=85",  # Sustainable craft visual
    ],

    # -------------------------------------------------------------
    # SERVICES.HTML (12 unique images)
    # -------------------------------------------------------------
    "services.html": [
    ...
    "gallery.html": [
        ...
        "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&auto=format&fit=crop&q=85",  # Living Walnut armchair
        ...
        "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?w=500&auto=format&fit=crop&q=80",  # Customer @j_whitfield
        "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=500&auto=format&fit=crop&q=80",  # Customer @elena_v
        "https://images.unsplash.com/photo-1549488344-1f9b8d2bd1f3?w=500&auto=format&fit=crop&q=80",  # Customer @amara_o
        "https://images.unsplash.com/photo-1560185893-a55cbc8c57e8?w=500&auto=format&fit=crop&q=80",  # Customer @marco_r
        "https://images.unsplash.com/photo-1595515106969-1ce29566ff1c?w=500&auto=format&fit=crop&q=80",  # Customer @yuki_t
        "https://images.unsplash.com/photo-1578898887932-dce23a595ad4?w=500&auto=format&fit=crop&q=80",  # Customer @michael_c
        "https://images.unsplash.com/photo-1519710164239-da123dc03ef4?w=500&auto=format&fit=crop&q=80",  # Customer @amelia_t
    ],

    # -------------------------------------------------------------
    # BLOG.HTML (13 unique images)
    # -------------------------------------------------------------
    "blog.html": [
        "https://images.unsplash.com/photo-1513694203232-719a280e022f?w=1600&auto=format&fit=crop&q=85", # Blog Hero BG
        "https://images.unsplash.com/photo-1616046229478-9901c5536a45?w=900&auto=format&fit=crop&q=85",  # Art of Layering Textures
        "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=600&auto=format&fit=crop&q=85",  # Choosing Perfect Sofa
        "https://images.unsplash.com/photo-1585128792020-803d29415281?w=600&auto=format&fit=crop&q=85",  # Biophilic Design
        "https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?w=600&auto=format&fit=crop&q=85",  # Bedroom Colour Palettes
        "https://images.unsplash.com/photo-1615066390971-03e4e1c36ddf?w=600&auto=format&fit=crop&q=85",  # Dining Table Guide
        "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=600&auto=format&fit=crop&q=85",  # Home Office Design
        "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&auto=format&fit=crop&q=85",  # Open Plan Living
        "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600&auto=format&fit=crop&q=85",  # Velvet Care Guide
        "https://images.unsplash.com/photo-1538688525198-9b88f6f53126?w=600&auto=format&fit=crop&q=85",  # Sustainable Furniture
        "https://images.unsplash.com/photo-1600210491892-03d54c0aaf87?w=400&auto=format&fit=crop&q=85",  # Design Tip 1
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&auto=format&fit=crop&q=85",  # Design Tip 2
        "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=400&auto=format&fit=crop&q=85",  # Design Tip 3
    ],

    # -------------------------------------------------------------
    # SINGLE IMAGE PAGES (1 unique image each)
    # -------------------------------------------------------------
    "contact.html": ["https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1600&auto=format&fit=crop&q=85"],
    "login.html": ["https://images.unsplash.com/photo-1616594039964-ae9021a400a0?w=1600&auto=format&fit=crop&q=85"],
    "signup.html": ["https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=1600&auto=format&fit=crop&q=85"],
    "terms.html": ["https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200&auto=format&fit=crop&q=85"],
    "privacy.html": ["https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=1200&auto=format&fit=crop&q=85"],
    "sitemap.html": ["https://images.unsplash.com/photo-1600585152220-90363fe7e115?w=1200&auto=format&fit=crop&q=85"],
    "open-plan-zoning.html": ["https://images.unsplash.com/photo-1600607687644-c7171b42498f?w=1200&auto=format&fit=crop&q=85"],
    "home-office-design.html": ["https://images.unsplash.com/photo-1517502884422-41eaead166d4?w=1200&auto=format&fit=crop&q=85"],
    "sustainable-furniture.html": ["https://images.unsplash.com/photo-1544457070-4cd773b4d71e?w=1200&auto=format&fit=crop&q=85"],
    "velvet-upholstery-care.html": ["https://images.unsplash.com/photo-1580481072645-022f9a6d8310?w=1200&auto=format&fit=crop&q=85"],
    "bedroom-colour-palettes.html": ["https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=1200&auto=format&fit=crop&q=85"],
    "dining-table-guide.html": ["https://images.unsplash.com/photo-1530018607912-eff2daa1bac4?w=1200&auto=format&fit=crop&q=85"],

    # -------------------------------------------------------------
    # CSS/PAGES/HOME.CSS (6 unique room background images)
    # -------------------------------------------------------------
    "home.css": [
...
# Now let's extract the Photo ID (e.g. photo-1555041469-a586c61ea9bc) for every single URL across all files
# to verify if there are any overlaps between files!
...
for fname, urls in MAPPING.items():
    file_photo_map[fname] = []
    for u in urls:
        m = photo_id_regex.search(u)
        if m:
            pid = m.group(1)
            all_photo_ids.append(pid)
            file_photo_map[fname].append(pid)
        else:
            print(f"WARNING: Could not parse photo ID from {u}")

print(f"Total mapped URLs across all files: {len(all_photo_ids)}")
print(f"Unique Photo IDs count: {len(set(all_photo_ids))}")

dupes = set([x for x in all_photo_ids if all_photo_ids.count(x) > 1])
if dupes:
    print("\n[!] DUPLICATES DETECTED! The following photo IDs are shared between files/slots:")
    for d in dupes:
        shared_in = [fname for fname, pids in file_photo_map.items() if d in pids]
        print(f"  - {d} is used in: {shared_in}")
else:
    print("\n[SUCCESS] PERFECT! All photo IDs are 100% unique globally across every single file!")
